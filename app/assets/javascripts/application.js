...
$(document).ready(function(){
	var refreshArray = [];
	// $(document).on('click', '#stringConcatButton', function(){});
	$(document).on('click', '#stringConcatButton', function(){
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	$(document).on('click', '#arrayPopButton', function(){
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////
//////////////////////////////////////////////////////////////////////////////////////////////////////////
	$(document).on('click', '#forLoopPushButton', function(){
...
console.log("hey")
		if (refreshArray.length === 1) {
			...
			$("<div>").appendTo(".animation-container").addClass("iValue").text("(i = "+$("#forLoopStart").val()+")").css({"font-weight":"bold"})
			...
			$(".animation-container").animate({opacity:1},1250)
			...
			function doSetTimeout(i){
				setTimeout(function(){
					...
					$(".iValue").animate({opacity:0},1250,function(){
						$(".iValue").text("(i = "+parseInt(i+ parseInt($("#forLoopIncrement").val()))+")")						
